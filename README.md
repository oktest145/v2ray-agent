...
> [English Version](https://github.com/oktest145/v2ray-agent/blob/master/documents/en/README_EN.md)

- [Cloudflare 优化方案](https://github.com/oktest145/v2ray-agent/blob/master/documents/optimize_V2Ray.md)
- [流量中转](https://github.com/oktest145/v2ray-agent/blob/master/documents/traffic_relay.md)
- [手动自建教程](https://github.com/oktest145/v2ray-agent/blob/master/documents/Cloudflare_install_manual.md)
...
- [公益订阅链接](https://github.com/oktest145/v2ray-agent/blob/master/documents/free_account.md)。
- **请给个⭐支持一下**
...
- [Cloudflare入门教程](https://github.com/oktest145/v2ray-agent/blob/master/documents/cloudflare_init.md)
...
- 支持纯IPv6，[IPv6注意事项](https://github.com/oktest145/v2ray-agent/blob/master/documents/ipv6_help.md)
- 支持IPv4[入]->IPv6分流[出]
- 支持WARP分流
- 支持日志管理
- 支持多端口配置
- [支持自定义证书安装](https://github.com/oktest145/v2ray-agent/blob/master/documents/install_tls.md)
...
- wget: command not found [**这里需要自己手动安装下wget**]
  ，如未使用过Linux，[点击查看](https://github.com/oktest145/v2ray-agent/tree/master/documents/install_tools.md)安装教程
- 不支持非root账户
...
- **[如有使用不明白的地方请先查看脚本使用指南](https://github.com/oktest145/v2ray-agent/blob/master/documents/how_to_use.md)**
...
## [脚本使用指南](https://github.com/oktest145/v2ray-agent/blob/master/documents/how_to_use.md)、[脚本目录](https://github.com/oktest145/v2ray-agent/blob/master/documents/how_to_use.md#5脚本目录)

## 捐赠

[您可以使用我的AFF进行购买VPS捐赠](https://github.com/oktest145/v2ray-agent/blob/master/documents/donation_aff.md)

[支持通过虚拟币向我捐赠](https://github.com/oktest145/v2ray-agent/blob/master/documents/donation.md)
...
```
wget -P /root -N --no-check-certificate "https://raw.githubusercontent.com/oktest145/v2ray-agent/stable_v2.4.16/install.sh" && chmod 700 /root/install.sh && /root/install.sh
```
